...
export interface Task {
  ...
  executionTicks?: Array<{ event: string; type: string; line?: number; column?: number; frameName?: string }>;
}
...
export interface RuntimeState {
  callStack: Task[];
  callStackFrames: Array<{ id: string; name: string }>;
  ...
  guessMode: boolean;          // Is Guess Mode enabled?
  userPrediction: string[];    // User's predicted output order for Guess Mode
}
